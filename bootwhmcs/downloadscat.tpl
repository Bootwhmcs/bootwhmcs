...
{include file="$template/pageheader.tpl" title=$LANG.downloadsfiles}
...
<div class="row">
  ...
  <div class="col-sm-4">
    {$download.type}
    {if $download.clientsonly} <i class="fa fa-lock"></i>{/if} <a href="{$download.link}"><strong>{$download.title}</strong></a>
